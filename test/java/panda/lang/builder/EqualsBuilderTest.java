...
public class EqualsBuilderTest {
	...
	public void testDouble() {
		...
		assertTrue(new EqualsBuilder().append(Double.POSITIVE_INFINITY, Double.POSITIVE_INFINITY)
			.isEquals());
	}
	...
	public void testFloat() {
		...
		assertTrue(new EqualsBuilder().append(Float.POSITIVE_INFINITY, Float.POSITIVE_INFINITY)
			.isEquals());
	}
	...
	public void testNpeForNullElement() {
		...
		final Object[] x2 = new Object[] { Integer.valueOf(1), Integer.valueOf(2),
				Integer.valueOf(3) };
