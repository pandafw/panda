...
import panda.net.telnet.TelnetOptionHandler;

import junit.framework.TestCase;

/***
 * The TelnetOptionHandlerTest is the abstract class for testing TelnetOptionHandler. It can be used
 * to derive the actual test classes for TelnetOptionHadler derived classes, by adding creation of
 * three new option handlers and testing of the specific subnegotiation behaviour.
 ***/
public abstract class TelnetOptionHandlerTestAbstract extends TestCase {
	...
	/***
	 * setUp for the test. The derived test class must implement this method by creating opthand1,
	 * opthand2, opthand3 like in the following: opthand1 = new EchoOptionHandler(); opthand2 = new
	 * EchoOptionHandler(true, true, true, true); opthand3 = new EchoOptionHandler(false, false,
	 * false, false);
	 ***/
	@Override
