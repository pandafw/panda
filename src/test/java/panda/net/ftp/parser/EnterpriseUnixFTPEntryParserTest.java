...
public class EnterpriseUnixFTPEntryParserTest extends FTPParseTestFramework {
	...
	public void testParseFieldsOnFile() throws Exception {
		FTPFile file = getParser().parseFTPEntry(
			"-C--E-----FTP B QUA1I1      18128       5000000000 Aug 12 13:56 QUADTEST");
	...
	public void testDefaultPrecision() {
		testPrecision("-C--E-----FTP B QUA1I1      18128       5000000000 Aug 12 2014 QUADTEST",
			CalendarUnit.DAY_OF_MONTH);
	}

	/**
	 * @see panda.net.ftp.parser.FTPParseTestFramework#getBadListing()
	 */
	@Override
	...
	/**
	 * @see panda.net.ftp.parser.FTPParseTestFramework#getGoodListing()
	 */
	@Override
	...
	private void checkPermisions(FTPFile dir) {
		assertTrue("Owner should not have read permission.",
			!dir.hasPermission(FTPFile.USER_ACCESS, FTPFile.READ_PERMISSION));
		assertTrue("Owner should not have write permission.",
			!dir.hasPermission(FTPFile.USER_ACCESS, FTPFile.WRITE_PERMISSION));
		...
		assertTrue("Group should not have read permission.",
			!dir.hasPermission(FTPFile.GROUP_ACCESS, FTPFile.READ_PERMISSION));
		assertTrue("Group should not have write permission.",
			!dir.hasPermission(FTPFile.GROUP_ACCESS, FTPFile.WRITE_PERMISSION));
		...
		assertTrue("World should not have read permission.",
			!dir.hasPermission(FTPFile.WORLD_ACCESS, FTPFile.READ_PERMISSION));
		assertTrue("World should not have write permission.",
			!dir.hasPermission(FTPFile.WORLD_ACCESS, FTPFile.WRITE_PERMISSION));
