...
public class MVSFTPEntryParserTest extends FTPParseTestFramework {
	...
	private static final String[] goodsamplesDatasetList = {
			/*
			 * Note, if the string begins with SAVE, the parsed entry is stored in the List
			 * saveftpfiles
			 */
	...
	private static final String[] goodsamplesJES1List = { /*
														 * no header for JES1 (JES Interface level
														 * 1)
														 */
	...
	private static final String[] badsamples = { "MigratedP201.$FTXPBI1.$CF2ITB.$AAB0402.I",
	...
	public void testParseFieldsOnFile() throws Exception {
		...
		file = parser
			.parseFTPEntry("SAVE00 3390   2004/06/23  1    1  FB     128  6144  PS    INCOMING.RPTBM023.D061704");
		assertNotNull("Could not parse entry.", file);
