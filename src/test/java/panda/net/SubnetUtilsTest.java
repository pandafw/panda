...
// deliberate use of deprecated methods
public class SubnetUtilsTest extends TestCase {
	...
	/**
	 * Test using the inclusiveHostCount flag, which includes the network and broadcast addresses in
	 * host counts
	 */
	...
	public void testNET521() {
		...
		// if we exclude the broadcast and network addresses, the count is less than
		// Integer.MAX_VALUE
		utils.setInclusiveHostCount(false);
		info = utils.getInfo();
