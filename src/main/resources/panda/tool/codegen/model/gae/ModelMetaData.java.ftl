...
<#list model.columnList as p>
	/**
	 * CN_${model.tableAlias?has_content?string(model.tableAlias!, model.table)?upper_case}_${p.column?upper_case} = "${p.column}";
	 */
	public final static String CN_${model.tableAlias?has_content?string(model.tableAlias!, model.table)?upper_case}_${p.column?upper_case} = "${p.column}";
