...
public class HTMLEntities {
	 ...
	 */
	public static final Map<String, String> BASIC_ESCAPE = Arrays.toMap(new String[][] { 
		{ "\"", "&quot;" }, // " - double-quote
		{ "&", "&amp;" }, // & - ampersand
		{ "<", "&lt;" }, // < - less-than
		{ ">", "&gt;" }, // > - greater-than
	 ...
	 */
	public static final Map<String, String> APOS_ESCAPE = Arrays.toMap(new String[][] { 
		{ "'", "&apos;" }, // XML apostrophe
	});
	 ...
	 */
	public static final Map<String, String> XML_UNESCAPE = invert(XML_ESCAPE);
	 ...
	 */
	public static final Map<String, String> ISO8859_1_ESCAPE = Arrays.toMap(new String[][] {
			{ "\u00A0", "&nbsp;" }, // non-breaking space
	 ...
	 */
	public static final Map<String, String> ISO8859_1_UNESCAPE = invert(ISO8859_1_ESCAPE);
	 ...
	 */
	public static final Map<String, String> HTML3_UNESCAPE = invert(HTML3_ESCAPE);

	/**
	 * Mapping to escape additional <a
	 * href="http://www.w3.org/TR/REC-html40/sgml/entities.html">character entity references</a>.
	 * Note that this must be used with {@link #ISO8859_1_ESCAPE} to get the full list of HTML 4.0
	 * character entities.
	 */
	public static final Map<String, String> HTML40_EXTENDED_ESCAPE = Arrays.toMap(new String[][] {
			// <!-- Latin Extended-B -->
			...
			// It is in ISOamsn --> 
			{ "\u2284", "&nsup;" }, // not a subset of, U+2284 ISOamsn -->
			...
			{ "\u2039", "&lsaquo;" }, // single left-pointing angle quotation mark,U+2039 ISO
										// proposed -->
			// <!-- lsaquo is proposed but not yet ISO standardized -->
			{ "\u203A", "&rsaquo;" }, // single right-pointing angle quotation mark,U+203A ISO
										// proposed -->
	 ...
	 */
	public static final Map<String, String> HTML40_EXTENDED_UNESCAPE = invert(HTML40_EXTENDED_ESCAPE);
	 ...
	 */
	public static final Map<String, String> HTML4_UNESCAPE = invert(HTML4_ESCAPE);
	 ...
	 * @return inverted map
	 */
	private static Map<String, String> invert(final Map<String, String> src) {
	 ...
	 * @return merged map
	 */
	private static Map<String, String> merge(final Map<String, String> ... src) {
		Map<String, String> des = new HashMap<String, String>();
