 ...
 * <li>从 Ioc 接口获得。 前提是，你必须在默认模块类中声明了 '@IocBy' 注解。并且你的参数数组的值为 {"ioc:xxx"}。 就是说，参数数组长度必须为 1。 ioc
 * 是否为大写无所谓，xxx 就是你的注入名称。
 * </ul>
 */
...
public @interface AdaptBy {
	...
	Class<? extends ParamAdaptor> type() default DefaultParamAdaptor.class;
