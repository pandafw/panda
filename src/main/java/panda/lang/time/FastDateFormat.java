 ...
 * </p>
 * <p>
 * This class can be used as a direct replacement to {@code SimpleDateFormat} in most formatting and
 ...
 * </p>
 * <p>
 * All patterns are compatible with SimpleDateFormat (except time zones and some year patterns - see
 * below).
 * </p>
 * <p>
 * FastDateFormat supports parsing as well as printing.
 * </p>
 * <p>
 * Java 1.4 introduced a new pattern letter, {@code 'Z'}, to represent time zones in RFC822 format
 * (eg. {@code +0800} or {@code -1100}). This pattern letter can be used here (on all JDK versions).
 * </p>
 * <p>
 * In addition, the pattern {@code 'ZZ'} has been made to represent ISO8601 full format time zones
 * (eg. {@code +08:00} or {@code -11:00}). This introduces a minor incompatibility with Java 1.4,
 * but at a gain of useful functionality.
 * </p>
 * <p>
 * Javadoc cites for the year pattern: <i>For formatting, if the number of pattern letters is 2, the
 * year is truncated to 2 digits; otherwise it is interpreted as a number.</i> Starting with Java
 * 1.7 a pattern of 'Y' or 'YYY' will be formatted as '2003', while it was '03' in former Java
