...
public class Booleans {
	...
	/**
	 * <p>
	 * {@code BooleanUtils} instances should NOT be constructed in standard programming. Instead,
	 * the class should be used as {@code BooleanUtils.negate(true);}.
	 * </p>
	 * <p>
	...
	public static Integer toIntegerObject(final boolean bool) {
		return bool ? Numbers.INTEGER_ONE : Numbers.INTEGER_ZERO;
	}
	...
	public static Integer toIntegerObject(final Boolean bool) {
		...
		return bool.booleanValue() ? Numbers.INTEGER_ONE : Numbers.INTEGER_ZERO;
	}
	 ...
	 * </p>
	 * <p>
	 * {@code 'true'}, {@code 'on'}, {@code 'y'}, {@code 't'} or {@code 'yes'} (case insensitive)
	 * will return {@code true}. {@code 'false'}, {@code 'off'}, {@code 'n'}, {@code 'f'} or
	 * {@code 'no'} (case insensitive) will return {@code false}. Otherwise, {@code null} is
	 * returned.
	 * </p>
	 * <p>
	 * NOTE: This returns null and will throw a NullPointerException if autoboxed to a boolean.
	 ...
	 * @param falseString the String to match for {@code false} (case sensitive), may be
	 *            {@code null}
	 * @param nullString the String to match for {@code null} (case sensitive), may be {@code null}
	 * @return the Boolean value of the string, {@code null} if either the String matches
	 *         {@code nullString} or if {@code null} input and {@code nullString} is {@code null}
	 ...
	 * </p>
	 * <p>
	 * This method performs 4 times faster (JDK1.4) than {@code Boolean.valueOf(String)}. However,
	...
	public static Boolean and(final Boolean... array) {
		...
		try {
			final boolean[] primitive = Arrays.toPrimitive(array);
