 ...
 * </p>
 * <p>
 * <b>Note:</b> It is mandatory to close the stream after the last byte has been written to it,
...
public class Base32OutputStream extends BaseNCodecOutputStream {
	 ...
	 *            characters (rounded down to nearest multiple of 4). If lineLength &lt;= 0, the
	 *            encoded data is not divided into lines. If doEncode is false, lineLength is
	 *            ignored.
