 ...
 * </pre></code>
 * <p>
 * Sometimes, such as in the case of TAR files, the magic number will be offset by a certain number
 * of bytes in the file. In the case of TAR archive files, this offset is 257 bytes.
 * </p>
 * <code><pre>
 * File dir = new File(".");
 ...
 * </pre></code>
 * 
 * @see FileFilters#magicNumberFileFilter(byte[])
 * @see FileFilters#magicNumberFileFilter(String)
 * @see FileFilters#magicNumberFileFilter(byte[], long)
 * @see FileFilters#magicNumberFileFilter(String, long)
 */
public class MagicNumberFileFilter extends AbstractFileFilter {
	 ...
	 * </p>
	 * <p>
	 * It is important to note that <em>the array is not cloned</em> and that any changes to the
