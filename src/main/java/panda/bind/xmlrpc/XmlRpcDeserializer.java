...
//	private static class XmlRpcHandler {
//		private static class XmlRpcValue {
//			private Type type;
//			private int kind;
...
//		private Type type;
//		private Object root;
//		private List<XmlRpcValue> stack;
//
//		public XmlRpcHandler(XmlRpcDeserializer deserializer, Type type) {
//			this.deser = deserializer;
//			this.type = type;
//			stack = new ArrayList<XmlRpcValue>();
//		}
//
...
//		}
//
//		protected XmlRpcValue lastValue() {
//			return stack.get(stack.size() - 1);
//		}
//
//		private void setValue(String name, String value) {
//			XmlRpcValue em = new XmlRpcValue();
//
//			em.name = name;
//
//			if (stack.isEmpty()) {
...
//					ep.beanh = deser.getBeanHandler(LinkedHashMap.class);
...
//		}
//
//		protected Object convertText(XmlRpcValue em) {
//			Object v = null;
...
//		}
//
//		protected Object convertValue(XmlRpcValue em) {
//			if (em.type == null) {
//				return null;
//			}
//
...
//				throw new XmlRpcException("Failed to convert value of property '" + em.name + "'", e);
//			}
//		}
//
//		private void endValue() {
//			XmlRpcValue em = stack.remove(stack.size() - 1);
//			if (em.type == null) {
//				return;
//			}
//
