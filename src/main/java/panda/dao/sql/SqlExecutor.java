...
public abstract class SqlExecutor {
	 ...
	 */
	protected SqlExecutor(SqlManager sqlManager) {
	 ...
	 * @throws java.sql.SQLException If an error occurs.
	 */
	protected abstract <T> T insert(String sql, Object parameter, Class<T> resultClass, T resultObject, String keyProp)
			throws SQLException;
	 ...
	 * @throws java.sql.SQLException If an SQL error occurs.
	 */
	public abstract <T> SqlResultSet<T> selectResultSet(String sql, Object parameter, Class<T> resultClass)
			throws SQLException;
	 ...
	 * @throws java.sql.SQLException If more than one result was found, or if any other error occurs.
	 */
	protected abstract <T> T fetch(String sql, Object parameter,
