...
public class TimeStamp implements java.io.Serializable, Comparable<TimeStamp> {
	 ...
	 * is, the hashcode is the value of the expression: <blockquote>
	 * 
	 * <pre>
	 ...
	 * only if the argument is not <code>null</code> and is a <code>Long</code> object that contains
	...
	/***
	 * Converts this <code>TimeStamp</code> object to a <code>String</code>. The NTP timestamp
	 ...
	 * @return the value <code>0</code> if the argument TimeStamp is equal to this TimeStamp; a
	 *         value less than <code>0</code> if this TimeStamp is numerically less than the
	 *         TimeStamp argument; and a value greater than <code>0</code> if this TimeStamp is
