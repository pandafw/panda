 ...
 * wire-level SSL details. Warning: the hostname is not verified against the certificate by default,
 * use {@link #setHostnameVerifier(HostnameVerifier)} or
 * {@link #setEndpointCheckingEnabled(boolean)} (on Java 1.7+) to enable verification. Verification
 * is only performed on client mode connections.
 * 
...
public class FTPSClient extends FTPClient {
	...
	/**
	 * Constructor for FTPSClient, calls {@link #FTPSClient(String, boolean)}. Sets protocol to
	 * {@link #DEFAULT_PROTOCOL} - i.e. TLS - and security mode to explicit (isImplicit = false)
	 */
	public FTPSClient() {
	 ...
	 * <li>P - Private</li>
	 * </ul>
	 * <b>N.B.</b> the method calls {@link #setSocketFactory(javax.net.SocketFactory)} and
