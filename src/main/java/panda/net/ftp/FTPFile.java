...
public class FTPFile implements Serializable {
	...
	/**
	 * Constructor for use by {@link FTPListParseEngine} only. Used to create FTPFile entries for
	 * failed parses
	 * 
	...
	/***
	 * Return the type of the file (one of the <code>_TYPE</code> constants), e.g., if it is a
	 * directory, a regular file, or a symbolic link.
	 * 
	...
	/***
	 * Set the name of the group owning the file. This may be a string representation of the group
	 * number.
	 * 
	...
	/***
	 * Returns the name of the group owning the file. Sometimes this will be a string representation
	 * of the group number.
	 * 
	...
	/***
	 * Set the name of the user owning the file. This may be a string representation of the user
	 * number;
	 * 
	...
	/***
	 * Returns the name of the user owning the file. Sometimes this will be a string representation
	 * of the user number.
	 * 
	...
	/***
	 * If the FTPFile is a symbolic link, use this method to set the name of the file being pointed
	...
	/***
	 * Set if the given access group (one of the <code> _ACCESS </code> constants) has the given
	 * access permission (one of the <code> _PERMISSION </code> constants) to the file.
	 * 
	...
	/***
	 * Determines if the given access group (one of the <code> _ACCESS </code> constants) has the
	 * given access permission (one of the <code> _PERMISSION </code> constants) to the file.
	 * 
	 * @param access The access group (one of the <code> _ACCESS </code> constants)
	 * @param permission The access permission (one of the <code> _PERMISSION </code> constants)
	 * @throws ArrayIndexOutOfBoundsException if either of the parameters is out of range
	 ...
	 * <p>
	 * Note: if the instance is not valid {@link #isValid()}, no useful information can be returned.
	 * In this case, use {@link #getRawListing()} instead.
	 * 
	 * @return A string representation of the FTPFile information.
	 */
	...
	/**
	 * Returns a string representation of the FTPFile information. This currently mimics the Unix
	 * listing format. This method allows the Calendar time zone to be overridden.
	 * <p>
	 * Note: if the instance is not valid {@link #isValid()}, no useful information can be returned.
	 * In this case, use {@link #getRawListing()} instead.
	 * 
	 * @param timezone the timezone to use for displaying the time stamp If {@code null}, then use
	 *            the Calendar entry timezone
	 * @return A string representation of the FTPFile information.
	 */
