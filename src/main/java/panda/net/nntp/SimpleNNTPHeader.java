 ...
 * <p>
 * The main purpose of the class is to faciliatate the article posting process, by relieving the
 * programmer from having to explicitly format an article header. For example:
 * 
 * <pre>
...
public class SimpleNNTPHeader {
	...
	/***
	 * Creates a new SimpleNNTPHeader instance initialized with the given from and subject header
	 * field values.
	 * <p>
	 * 
	 * @param from The value of the <code>From:</code> header field. This should be the article
	 *            poster's email address.
	 * @param subject The value of the <code>Subject:</code> header field. This should be the
	...
	/***
	 * Adds an arbitrary header field with the given value to the article header. These headers will
	 * be written after the From, Newsgroups, and Subject fields when the SimpleNNTPHeader is
	 * convertered to a string. An example use would be:
	 * 
	 * <pre>
	 * header.addHeaderField(&quot;Organization&quot;, &quot;Foobar, Inc.&quot;);
	 * </pre>
	...
	/***
	 * Converts the SimpleNNTPHeader to a properly formatted header in the form of a String,
	 * including the blank line used to separate the header from the article body.
	 * <p>
	 * 
