...
public abstract class TFTPPacket {
	/***
	 * The minimum size of a packet. This is 4 bytes. It is enough to store the opcode and
	 * blocknumber or other required data depending on the packet type.
	 ***/
	static final int MIN_PACKET_SIZE = 4;

	/***
	 * This is the actual TFTP spec identifier and is equal to 1. Identifier returned by
	 * {@link #getType getType()} indicating a read request packet.
	 ***/
	public static final int READ_REQUEST = 1;

	/***
	 * This is the actual TFTP spec identifier and is equal to 2. Identifier returned by
	 * {@link #getType getType()} indicating a write request packet.
	 ***/
	public static final int WRITE_REQUEST = 2;

	/***
	 * This is the actual TFTP spec identifier and is equal to 3. Identifier returned by
	 * {@link #getType getType()} indicating a data packet.
	 ***/
	public static final int DATA = 3;

	/***
	 * This is the actual TFTP spec identifier and is equal to 4. Identifier returned by
	 * {@link #getType getType()} indicating an acknowledgement packet.
	 ***/
	public static final int ACKNOWLEDGEMENT = 4;

	/***
	 * This is the actual TFTP spec identifier and is equal to 5. Identifier returned by
	 * {@link #getType getType()} indicating an error packet.
	 ***/
	public static final int ERROR = 5;

	/***
	 * The TFTP data packet maximum segment size in bytes. This is 512 and is useful for those
	 * familiar with the TFTP protocol who want to use the {@link panda.net.tftp.TFTP} class methods
	 * to implement their own TFTP servers or clients.
	 ***/
	 ...
	 * to create the proper TFTPPacket object encapsulating the data contained in that datagram.
	 * This method is the only way you can instantiate a TFTPPacket derived class from a datagram.
	 * 
	 * @param datagram The datagram containing a TFTP packet.
	 * @return The TFTPPacket object corresponding to the datagram.
	 * @exception TFTPPacketException If the datagram does not contain a valid TFTP packet.
	 ***/
	...
	/***
	 * This constructor is not visible outside of the package. It is used by subclasses within the
	 * package to initialize base data.
	 * 
	...
	/***
	 * This is an abstract method only available within the package for implementing efficient
	 * datagram transport by elminating buffering. It takes a datagram as an argument, and a byte
	 * buffer in which to store the raw datagram data. Inside the method, the data should be set as
	 * the datagram's data and the datagram returned.
	 * 
	...
	/***
	 * Creates a UDP datagram containing all the TFTP packet data in the proper format. This is an
	 * abstract method, exposed to the programmer in case he wants to implement his own TFTP client
	 * instead of using the {@link panda.net.tftp.TFTPClient} class. Under normal circumstances, you
