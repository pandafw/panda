...
public class TerminalTypeOptionHandler extends TelnetOptionHandler {
	...
	/***
	 * Constructor for the TerminalTypeOptionHandler. Allows defining desired initial setting for
	...
	/***
	 * Constructor for the TerminalTypeOptionHandler. Initial and accept behaviour flags are set to
	 * false
	 * <p>
	 * 
	 * @param termtype - terminal type that will be negotiated.
