...
public class WindowSizeOptionHandler extends TelnetOptionHandler {
	...
	/***
	 * Constructor for the WindowSizeOptionHandler. Allows defining desired initial setting for
	 ...
	 ***/
	public WindowSizeOptionHandler(int nWidth, int nHeight, boolean initlocal, boolean initremote, boolean acceptlocal,
	...
	/***
	 * Constructor for the WindowSizeOptionHandler. Initial and accept behaviour flags are set to
	 * false
	 * <p>
	 * 
	 * @param nWidth - Window width.
	...
	/***
	 * Implements the abstract method of TelnetOptionHandler. This will send the client Height and
	 * Width to the server.
	 * <p>
	 * 
