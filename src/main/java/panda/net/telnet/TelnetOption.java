...
/***
 * The TelnetOption class cannot be instantiated and only serves as a storehouse for telnet option
 * constants.
 * <p>
...
public class TelnetOption {
	...
	/***
	 * Returns the string representation of the telnet protocol option corresponding to the given
	 * option code.
	 * 
