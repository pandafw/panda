...
public class SubnetUtils {
	...
	/*
	 * Convenience method to extract the components of a dotted decimal address and pack into an
	...
	/*
	 * Convenience function to check integer boundaries. Checks if a value x is in the range
	 * [begin,end]. Returns x if it is in range, throws an exception otherwise.
	 */
	...
	/*
	 * Count the number of 1-bits in a 32-bit integer using a divide-and-conquer strategy see
	...
	/*
	 * Convert two dotted decimal addresses to a single xxx.xxx.xxx.xxx/yy format by counting the
	 * 1-bit population in the mask address. (It may be better to count NBITS-#trailing zeroes for
	 * this case)
	 */
