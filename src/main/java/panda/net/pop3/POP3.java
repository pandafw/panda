...
public class POP3 extends SocketClient {
	 ...
	 * lines have end of lines truncated. If the reply is a single line, but its format ndicates it
	 * should be a multiline reply, then you must call {@link #getAdditionalReply
	 * getAdditionalReply() } to fetch the rest of the reply, and then call
	 * <code>getReplyStrings</code> again. You only have to worry about this if you are implementing
	 ...
	 * containing all the reply lines including newlines. If the reply is a single line, but its
	 * format ndicates it should be a multiline reply, then you must call
	 * {@link #getAdditionalReply getAdditionalReply() } to fetch the rest of the reply, and then
	 * call <code>getReplyString</code> again. You only have to worry about this if you are
	 * implementing your own client using the {@link #sendCommand sendCommand } methods.
	 * 
	 * @return The last server response.
	 ***/
