...
<div class="p-section">
	...
	<#if action.hasPermission("template_copy")>
	...
	<#if action.hasPermission("template_update")>
		<#assign _actions_ = _actions_ + [{
	...
	<#if action.hasPermission("template_delete")>
		<#assign _actions_ = _actions_ + [{
	...
	<#if action.hasPermission("template_bdelete")>
	...
	<@p.listview id="template_list" action="template_list" 
		...
		link={ "action": "template_view", "params": { "d.id": "id" } }
	>
		<@s.param name="tools">
			<#if action.hasPermission("template_bdelete")>
				<@p.submit icon="icon-bdelete" action="template_bdelete" onclick="return template_list_bdelete();" theme="simple"><@p.text name="button-bdelete"/></@p.submit>
			</#if>
			<#if action.hasPermission("template_list_print")>
				<@p.submit icon="icon-print" onclick="return template_list_print();" theme="simple"><@p.text name="button-print"/></@p.submit>
			</#if>
			<#if action.hasPermission("template_list_csv")>
				<@p.submit icon="icon-csv" onclick="return template_list_csv();" theme="simple"><@p.text name="button-csv"/></@p.submit>
			</#if>
			<#if action.hasPermission("template_list_print")>
				<@p.submit icon="icon-pdf-list_print" onclick="return template_list_pdf_list_print();" theme="simple"><@p.text name="button-pdf-list_print"/></@p.submit>
			</#if>
		</@s.param>
	</@p.listview>
	...
	<script type="text/javascript"><!--
		function template_list_bdelete() {
			return nlv_submitCheckedKeys('template_list', '<@p.url action="template_bdelete"/>');
		}
		function template_list_print() {
			window.open("<@p.url action='template_list_print' includeParams='all' escapeAmp='false'/>");
			return false;
		}
		function template_list_csv() {
			window.open("<@p.url action='template_list_csv' includeParams='all' escapeAmp='false'/>");
			return false;
		}
		function template_list_pdf_list_print() {
			window.open("<@p.url action='pdf' namespace='/' escapeAmp='false'/>?url=" + encodeURIComponent("<@p.url action='template_list_print' forceAddSchemeHostAndPort='true' escapeAmp='false'/>" + location.search));
			return false;
		}
	--></script>
</div>
