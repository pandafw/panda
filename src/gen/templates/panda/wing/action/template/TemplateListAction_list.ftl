...
<div class="p-section">
	...
	<@p.set var="lvtools">
		...
		<#if action.hasPermission("~/list_json")>
			<@p.submit icon="icon-json" onclick="return template_list_json();" theme="simple"><@p.text name="button-json"/></@p.submit>
		</#if>
		<#if action.hasPermission("~/list_xml")>
			<@p.submit icon="icon-xml" onclick="return template_list_xml();" theme="simple"><@p.text name="button-xml"/></@p.submit>
		</#if>
		<#if action.hasPermission("/pdf")>
			<@p.submit icon="icon-pdf" onclick="return template_list_pdf();" theme="simple"><@p.text name="button-pdf"/></@p.submit>
		</#if>
	</@p.set>
