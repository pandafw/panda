...
<div class="p-section">
	...
	<@p.form cssClass="p-cform" id="template" initfocus="true" method="post" theme="bs3h">
		...
		<@p.div cssClass="p-buttons">
			<@p.submit icon="icon-copy-execute" action="template_copy_execute"><@p.text name="button-copy-execute"/></@p.submit>
			<@p.submit icon="icon-back" action="template_copy_input"><@p.text name="button-back"/></@p.submit>
		</@p.div>
	</@p.form>
</div>
