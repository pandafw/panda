...
<div class="p-section">
	...
	<@p.set var="lvtools">
		<#if action.hasPermission("~/bdelete")>
			<@p.b icon="icon-bdelete" onclick="return resource_list_bdelete();" label="#(button-bdelete)"/>
		</#if>
		<#if action.hasPermission("~/list_print")>
			<@p.b icon="icon-print" onclick="return resource_list_print();" label="#(button-print)"/>
		</#if>
		<#if action.hasPermission("~/list_csv")>
			<@p.b icon="icon-csv" onclick="return resource_list_csv();" label="#(button-csv)"/>
		</#if>
		<#if action.hasPermission("~/list_json")>
			<@p.b icon="icon-json" onclick="return resource_list_json();" label="#(button-json)"/>
		</#if>
		<#if action.hasPermission("~/list_xml")>
			<@p.b icon="icon-xml" onclick="return resource_list_xml();" label="#(button-xml)"/>
		</#if>
	</@p.set>
