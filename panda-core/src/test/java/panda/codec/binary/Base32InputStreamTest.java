...
import panda.codec.binary.Base32InputStream;
...
public class Base32InputStreamTest {
    ...
    public void testCodec130() throws IOException {
        ...
        base32os.write(Strings.getBytesUtf8(STRING_FIXTURE));
        base32os.close();
        ...
        final String str = Strings.newStringUtf8(decodedBytes);
    ...
    // byte[] codec101 = Strings.getBytesUtf8(Base32TestData.CODEC_101_MULTIPLE_OF_3);
    ...
    // byte[] codec98 = Strings.getBytesUtf8(Base32TestData.CODEC_98_NPE);
    ...
    //
    // String decoded = Strings.newStringUtf8(decodedBytes);
    // assertEquals(
    ...
    public void testAvailable() throws Throwable {
        final InputStream ins = new ByteArrayInputStream(Strings.getBytesIso8859_1(ENCODED_FOO));
    ...
    public void testBase32InputStreamByChunk() throws Exception {
        // Hello World test.
        byte[] encoded = Strings.getBytesUtf8(Base32TestData.BASE32_FIXTURE);
        byte[] decoded = Strings.getBytesUtf8(Base32TestData.STRING_FIXTURE);
        ...
        // encoded = Strings.getBytesUtf8(Base32TestData.ENCODED_32_CHARS_PER_LINE);
    ...
    public void testMarkSupported() throws Exception {
        final byte[] decoded = Strings.getBytesUtf8(Base32TestData.STRING_FIXTURE);
