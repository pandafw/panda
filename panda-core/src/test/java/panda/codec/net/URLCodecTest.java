 ...
 * 
 * @version $Id: URLCodecTest.java 1683555 2015-06-04 14:22:20Z sebb $
 */
public class URLCodecTest {
	...
	public void testUTF8RoundTrip() throws Exception {
		...
		assertEquals("%D0%92%D1%81%D0%B5%D0%BC_%D0%BF%D1%80%D0%B8%D0%B2%D0%B5%D1%82",
			urlCodec.encode(ru_msg, Charsets.UTF_8));
		assertEquals("Gr%C3%BCezi_z%C3%A4m%C3%A4", urlCodec.encode(ch_msg, Charsets.UTF_8));

		assertEquals(ru_msg, urlCodec.decode(urlCodec.encode(ru_msg, Charsets.UTF_8), Charsets.UTF_8));
		assertEquals(ch_msg, urlCodec.decode(urlCodec.encode(ch_msg, Charsets.UTF_8), Charsets.UTF_8));
		this.validateState(urlCodec);
	}
