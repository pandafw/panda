...
import panda.codec.net.QuotedPrintableCodec;
import panda.lang.Charsets;

/**
 * Quoted-printable codec test cases
 * 
 * @version $Id: QuotedPrintableCodecTest.java 1694610 2015-08-07 03:47:38Z ggregory $
 */
public class QuotedPrintableCodecTest {
	...
	public void testUTF8RoundTrip() throws Exception {
		...
		assertEquals("=D0=92=D1=81=D0=B5=D0=BC_=D0=BF=D1=80=D0=B8=D0=B2=D0=B5=D1=82",
			qpcodec.encode(ru_msg, Charsets.UTF_8));
		assertEquals("Gr=C3=BCezi_z=C3=A4m=C3=A4", qpcodec.encode(ch_msg, Charsets.UTF_8));

		assertEquals(ru_msg, qpcodec.decode(qpcodec.encode(ru_msg, Charsets.UTF_8), Charsets.UTF_8));
		assertEquals(ch_msg, qpcodec.decode(qpcodec.encode(ch_msg, Charsets.UTF_8), Charsets.UTF_8));
	}
	...
	public void testEncodeUrlWithNullBitSet() throws Exception {
		...
		final String encoded = new String(QuotedPrintableCodec.encodeQuotedPrintable(null,
