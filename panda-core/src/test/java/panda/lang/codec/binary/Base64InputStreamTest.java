...
import panda.lang.codec.binary.Base64InputStream;
...
public class Base64InputStreamTest {
    ...
    public void testCodec130() throws IOException {
        ...
        base64os.write(Strings.getBytesUtf8(STRING_FIXTURE));
        base64os.close();
    ...
    public void testCodec101() throws Exception {
        final byte[] codec101 = Strings.getBytesUtf8(Base64TestData.CODEC_101_MULTIPLE_OF_3);
    ...
    public void testAvailable() throws Throwable {
        final InputStream ins = new ByteArrayInputStream(Strings.getBytesIso8859_1(ENCODED_B64));
    ...
    public void testMarkSupported() throws Exception {
        final byte[] decoded = Strings.getBytesUtf8(STRING_FIXTURE);
