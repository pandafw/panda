...
/**
 * Unit tests {NoFieldNamesToStringStyleTest}.
 *
 */
public class NoFieldNamesToStringStyleTest {
	...
	public void testAppendSuper() {
		...
		assertEquals(baseStr + "{hello}", new ToStringBuilder(base).appendSuper("Integer@8888{}").append("a", "hello")
			.toString());
		assertEquals(baseStr + "{<null>,hello}",
...
//			.toString());
	...
	public void testPerson() {
		...
		assertEquals(pBaseStr + "{Ron Paul,72,false}",
