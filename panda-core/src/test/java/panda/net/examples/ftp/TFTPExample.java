package panda.net.examples.ftp;
...
/***
 * This is an example of a simple Java tftp client. Notice how all of the code is really just
 ...
 * localfile - The name of the local file to send or the name to use for the received file
 * remotefile - The name of the remote file to receive or the name for the remote server to use to
 * name the local file being sent. options: (The default is to assume -r -b) -s Send a local file -r
 * Receive a remote file -a Use ASCII transfer mode -b Use binary transfer mode
 ***/
