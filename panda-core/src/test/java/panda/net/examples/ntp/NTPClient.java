...
/***
 * This is an example program demonstrating how to use the NTPUDPClient class. This program sends a
 * Datagram client request packet to a Network time Protocol (NTP) service port on a specified
 * server, retrieves the time, and prints it to standard output along with the fields from the NTP
 * message header (e.g. stratum level, reference id, poll interval, root delay, mode, ...) See <A
