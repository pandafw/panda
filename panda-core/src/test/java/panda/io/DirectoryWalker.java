...
public abstract class DirectoryWalker<T> {
     ...
     * part of the walk. The {@link FileFilters} class is useful for combining
     ...
     * of the walk. This constructor uses {@link FileFilters#makeDirectoryOnly(IOFileFilter)}
     * and {@link FileFilters#makeFileOnly(IOFileFilter)} internally to combine the filters.
    ...
    protected DirectoryWalker(IOFileFilter directoryFilter, IOFileFilter fileFilter, final int depthLimit) {
        if (directoryFilter == null && fileFilter == null) {
            ...
            directoryFilter = FileFilters.makeDirectoryOnly(directoryFilter);
            fileFilter = FileFilters.makeFileOnly(fileFilter);
            this.filter = FileFilters.or(directoryFilter, fileFilter);
        }
        this.depthLimit = depthLimit;
    }
