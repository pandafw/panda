...
public abstract class FileBasedTestCase extends TestCase {
	...
	private void assertEqualContent(final File f0, final File f1) throws IOException {
		/*
		 * This doesn't work because the filesize isn't updated until the file is closed.
		 * assertTrue( "The files " + f0 + " and " + f1 + " have differing file sizes (" +
		 * f0.length() + " vs " + f1.length() + ")", ( f0.length() == f1.length() ) );
		 */
