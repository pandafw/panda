...
public class NtpV3Impl implements NtpV3Packet {
	...
	/***
	 * Set originate timestamp given NTP TimeStamp object. If <code>ts</code> is null then zero time
	 * is used.
	 * 
	 * @param ts NTP timestamp
	 */
	...
	/***
	 * Set receive timestamp given NTP TimeStamp object. If <code>ts</code> is null then zero time
	 * is used.
	 * 
	 * @param ts timestamp
	 */
	 ...
	 * only if the argument is not <code>null</code> and is a <code>NtpV3Impl</code> object that
