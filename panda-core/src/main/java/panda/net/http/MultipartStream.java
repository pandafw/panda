...
public class MultipartStream {
	 ...
	 *         otherwise.
	 * @throws SizeLimitExceededException if the bytes read from the stream exceeded the size limits
	 * @throws MalformedStreamException if the stream ends unexpectedly or fails to follow required
	 *             syntax.
	 */
	public boolean readBoundary() throws SizeLimitExceededException, MalformedStreamException {
	 ...
	 */
	public String readHeaders() throws SizeLimitExceededException, MalformedStreamException {
		int i = 0;
		byte b;
	 ...
	 * (see {@link #MultipartStream(InputStream,byte[],int, MultipartStream.ProgressNotifier)
	 * constructor}).
	 * 
	...
	public class ItemInputStream extends InputStream {
		...
		protected void assertClosed() throws IOException {
			if (closed) {
