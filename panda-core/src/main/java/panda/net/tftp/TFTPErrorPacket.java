...
public final class TFTPErrorPacket extends TFTPPacket {
	...
	/***
	 * Creates an error packet to be sent to a host at a given port with an error code and error
	 * message.
	 * 
	...
	/***
	 * Creates an error packet based from a received datagram. Assumes the datagram is at least
	 * length 4, else an ArrayIndexOutOfBoundsException may be thrown.
	 * 
	...
	/***
	 * Creates a UDP datagram containing all the TFTP error packet data in the proper format. This
