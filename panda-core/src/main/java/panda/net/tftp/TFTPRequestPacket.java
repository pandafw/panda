...
/***
 * An abstract class derived from TFTPPacket definiing a TFTP Request packet type. It is subclassed
 * by the {@link panda.net.tftp.TFTPReadRequestPacket} and
 * {@link panda.net.tftp.TFTPWriteRequestPacket} classes.
 * <p>
...
public abstract class TFTPRequestPacket extends TFTPPacket {
	/***
	 * An array containing the string names of the transfer modes and indexed by the transfer mode
	 * constants.
	 ***/
	static final String[] _modeStrings = { "netascii", "octet" };

	/***
	 * A null terminated byte array representation of the ascii names of the transfer mode
	 * constants. This is convenient for creating the TFTP request packets.
	 ***/
	...
	/***
	 * Creates a request packet of a given type to be sent to a host at a given port with a filename
	 * and transfer mode request.
	 * 
	...
	/***
	 * Creates a request packet of a given type based on a received datagram. Assumes the datagram
	 * is at least length 4, else an ArrayIndexOutOfBoundsException may be thrown.
	 * 
	 * @param type The type of the request (either TFTPPacket.READ_REQUEST or
	 *            TFTPPacket.WRITE_REQUEST).
	...
	/***
	 * Creates a UDP datagram containing all the TFTP request packet data in the proper format. This
	 * is a method exposed to the programmer in case he wants to implement his own TFTP client
