...
public class CreditCardNumberValidator {
	 ...
	 */
	protected boolean luhnCheck(String cardno) {
		...
		for (int count = 0; count < digits; count++) {
			int digit = 0;
			try {
				digit = Integer.parseInt(cardno.charAt(count) + "");
			}
	 ...
	 * @return Whether the card number is valid.
	 */
	public static boolean isValidAmexCard(String cardno) {
		return checkCardNumber(cardno, PREFIX_AMEX_0, LENGTH_AMEX_0);
	}
	 ...
	 * @return Whether the card number is valid.
	 */
	public static boolean isValidVisaCard(String cardno) {
		return checkCardNumber(cardno, PREFIX_VISA_0, LENGTH_VISA_0);
	}
	 ...
	 * @return Whether the card number is valid.
	 */
	public static boolean isValidMasterCard(String cardno) {
		return checkCardNumber(cardno, PREFIX_MASTERCARD_0, LENGTH_MASTERCARD_0);
	}
	 ...
	 * @return Whether the card number is valid.
	 */
	public static boolean isValidDiscoverCard(String cardno) {
		return checkCardNumber(cardno, PREFIX_DISCOVER_0, LENGTH_DISCOVER_0);
	}
	 ...
	 * @return Whether the card number is valid.
	 */
	public static boolean isValidDinersCard(String cardno) {
		return checkCardNumber(cardno, PREFIX_DINERS_0, LENGTH_DINERS_0);
	}
	 ...
	 * @return Whether the card number is valid.
	 */
	public static boolean isValidJcbCard(String cardno) {
		return checkCardNumber(cardno, PREFIX_JCB_0, LENGTH_JCB_0)
				|| checkCardNumber(cardno, PREFIX_JCB_1, LENGTH_JCB_1);
	}
	 ...
	 * @return Whether the card number is valid.
	 */
	protected static boolean checkCardNumber(String cardno, String[] prefixArray, int[] lengthArray) {
		for (int length : lengthArray) {
			if (length == cardno.length()) {
				for (String prefix : prefixArray) {
					if (prefix.equals(cardno.substring(0, prefix.length()))) {
						return true;
					}
				}
			}
