 ...
 * </p>
 * <p>
 * Only formatting is supported, but all patterns are compatible with SimpleDateFormat (except time
 * zones and some year patterns - see below).
 * </p>
 * <p>
...
public class FastDatePrinter implements DatePrinter, Serializable {
	...
	public <B extends Appendable> B format(Calendar calendar, final B buf) {
		// do not pass in calendar directly, this will cause TimeZone of FastDatePrinter to be
		// ignored
