...
public class Strings {
     ...
     * @deprecated This feature will be removed in Lang 4.0, use {@link Strings#removeEnd(String, String)} instead
     */
    @Deprecated
     ...
     *
     * <p>For a word based algorithm, see {@link Texts#uncapitalize(String)}.
     * A {@code null} input String returns {@code null}.</p>
     *
     * <pre>
     ...
     * </ul>
     *
     * <p>For a word based algorithm, see {@link Texts#swapCase(String)}.
     * A {@code null} input String returns {@code null}.</p>
     *
     * <pre>
     ...
     * That functionality is available in Texts.</p>
     *
	 ...
	 */
	public static boolean startsWithChars(String string, String chars, boolean ignoreCase) {
	...
	public static List<String> parseCsv(String str, char separator) {
		...
		CsvReader cr = null;
		try {
			cr = new CsvReader(new StringReader(str), separator);
			return cr.readNext();
		}
		catch (IOException e) {
			throw new RuntimeException(e);
