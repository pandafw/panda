 ...
 */
public class ObjectTypeAdapter<T> extends AbstractTypeAdapter<T, Object> {
	public ObjectTypeAdapter(TypeAdapters adapters, Class<T> toType) {
		super(adapters, toType, Object.class);
	}
	...
	public void updateResult(ResultSet rs, String columnName, Object value, String jdbcType)
		...
		if (value == null) {
			...
			rs.updateObject(columnName, castToJdbc(value));
		}
	}
	...
	public void updateResult(ResultSet rs, int columnIndex, Object value, String jdbcType)
		...
		if (value == null) {
			...
			rs.updateObject(columnIndex, castToJdbc(value));
		}
	}
	...
	public void setParameter(PreparedStatement ps, int i, Object parameter, String jdbcType)
			throws SQLException {
		ps.setObject(i, castToJdbc(parameter));
	}
}
