...
<#if a.canAccess("./add")><li><@p.a action="./add" icon="icon-new" label="#(btn-new)"/>
	...
	<#assign _columns_ = _columns_ + [{
			...
			"filter": {
				"type": "date",
				"enable": a.filterField("publishDate")
			},
			"sortable": true,
	...
	<@p.set var="lvtools">
		<#if a.canAccess("./bdelete")>
			<@p.b onclick="return pages_list_bdelete();" icon="icon-bdelete" label="#(btn-bdelete)"/>
		</#if>
		<#if a.canAccess("./benable")>
			<@p.b onclick="return pages_list_benable();" icon="icon-benable" label="#(btn-benable)"/>
		</#if>
		<#if a.canAccess("./bdisable")>
			<@p.b onclick="return pages_list_bdisable();" icon="icon-bdisable" label="#(btn-bdisable)"/>
		</#if>
	</@p.set>

	<@p.queryer id="pages_list_qr" action="./list"
		columns=_columns_
	/>

	<@p.listview id="pages_list" action="./list"
	...
	<script type="text/javascript"><!--
		function pages_list_bdelete() {
			return plv_submitCheckedKeys('pages_list', '<@p.url action="./bdelete"/>', null, "");
		}
		function pages_list_benable() {
			return plv_submitCheckedKeys('pages_list', '<@p.url action="./benable"/>', null, "");
		}
		function pages_list_bdisable() {
			return plv_submitCheckedKeys('pages_list', '<@p.url action="./bdisable"/>', null, "");
		}
	--></script>
</div>
