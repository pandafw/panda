...
/***
 * NewsgroupInfo stores information pertaining to a newsgroup returned by the NNTP GROUP, LIST, and
 * NEWGROUPS commands, implemented by {@link panda.net.nntp.NNTPClient#selectNewsgroup
 * selectNewsgroup } , {@link panda.net.nntp.NNTPClient#listNewsgroups listNewsgroups } , and
 * {@link panda.net.nntp.NNTPClient#listNewNewsgroups listNewNewsgroups } respectively.
 * 
 * @see NNTPClient
 ***/
...
public final class NewsgroupInfo {
	 ...
	 * buffer.append(__newsgroup); buffer.append(' '); buffer.append(__lastArticle);
	 * buffer.append(' '); buffer.append(__firstArticle); buffer.append(' ');
	 * switch(__postingPermission) { case 1: buffer.append('m'); break; case 2: buffer.append('y');
	 * break; case 3: buffer.append('n'); break; } return buffer.toString(); }
	 */
