...
/**
 * Parser for the Connect Enterprise Unix FTP Server From Sterling Commerce. Here is a sample of the
 * sort of output line this parser processes:
 * "-C--E-----FTP B QUA1I1      18128       41 Aug 12 13:56 QUADTEST"
 * <P>
 * <B> Note: EnterpriseUnixFTPEntryParser can only be instantiated through the
 * DefaultFTPParserFactory by classname. It will not be chosen by the autodetection scheme. </B>
 * 
...
public class EnterpriseUnixFTPEntryParser extends RegexFTPFileEntryParserImpl {
	...
	/**
	 * months abbreviations looked for by this parser. Also used to determine <b>which</b> month has
	...
	/**
	 * Parses a line of a unix FTP server file listing and converts it into a usable format in the
