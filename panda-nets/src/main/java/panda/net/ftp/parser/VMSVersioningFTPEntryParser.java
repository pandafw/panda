...
/**
 * Special implementation VMSFTPEntryParser with versioning turned on. This parser removes all
 * duplicates and only leaves the version with the highest version number for each filename. This is
 * a sample of VMS LIST output
...
public class VMSVersioningFTPEntryParser extends VMSFTPEntryParser {
	...
	/**
	 * This constructor allows the creation of a VMSVersioningFTPEntryParser object with something
	...
	/**
	 * Implement hook provided for those implementers (such as VMSVersioningFTPEntryParser, and
	 * possibly others) which return multiple files with the same name to remove the duplicates ..
	 * 
