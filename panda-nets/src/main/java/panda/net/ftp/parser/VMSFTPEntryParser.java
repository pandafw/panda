...
/**
 * Implementation FTPFileEntryParser and FTPFileListParser for VMS Systems. This is a sample of VMS
 * LIST output
 ...
 * ,
 * <P>
 * <B> Note: VMSFTPEntryParser can only be instantiated through the DefaultFTPParserFactory by
 * classname. It will not be chosen by the autodetection scheme. </B>
 * <P>
 * 
...
public class VMSFTPEntryParser extends ConfigurableFTPFileEntryParserImpl {
	...
	/**
	 * This constructor allows the creation of a VMSFTPEntryParser object with something other than
	...
	/**
	 * Parses a line of a VMS FTP server file listing and converts it into a usable format in the
	 * form of an <code> FTPFile </code> instance. If the file listing line doesn't describe a file,
	 * <code> null </code> is returned, otherwise a <code> FTPFile </code> instance representing the
	 ...
	 * entry from the next. This parser cannot use the default implementation of simply calling
	 * BufferedReader.readLine(), because one entry may span multiple lines.
	 * 
	...
	public FTPFile[] parseFileList(java.io.InputStream listStream) throws IOException {
		panda.net.ftp.FTPListParseEngine engine = new panda.net.ftp.FTPListParseEngine(this);
