...

{
	...
	/**
	 * This constructor allows the creation of an OS2FTPEntryParser object with something other than
	...
	/**
	 * Parses a line of an OS2 FTP server file listing and converts it into a usable format in the
