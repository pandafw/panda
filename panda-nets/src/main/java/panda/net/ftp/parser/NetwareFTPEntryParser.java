 ...
 * the proprietary extensions for Novell-specific operations are not supported. See <a href=
 * "http://www.novell.com/documentation/nw65/index.html?page=/documentation/nw65/ftp_enu/data/fbhbgcfa.html"
 * > http://www.novell.com/documentation/nw65/index.html?page=/documentation/nw65/ftp_enu/data/
 * fbhbgcfa.html</a> for more details.
 * 
...
public class NetwareFTPEntryParser extends ConfigurableFTPFileEntryParserImpl {
	 ...
	 * the form of an <code> FTPFile </code> instance. If the file listing line doesn't describe a
	 * file, <code> null </code> is returned, otherwise a <code> FTPFile </code> instance
	...
	public FTPFile parseFTPEntry(String entry) {
		...
		if (matches(entry)) {
			...
			// Now set the permissions (or at least a subset thereof - full permissions would
			// probably require
