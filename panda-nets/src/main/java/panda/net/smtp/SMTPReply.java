...
/***
 * SMTPReply stores a set of constants for SMTP reply codes. To interpret the meaning of the codes,
 * familiarity with RFC 821 is assumed. The mnemonic constant names are transcriptions from the code
 * descriptions of RFC 821.
 ***/
...
public final class SMTPReply {
	 ...
	 * tentative success. No further commands can be issued to the SMTP server after a positive
	 ...
	 * positive completion responses. The SMTP server will send a positive completion response on
	 ...
	 * are positive intermediate responses. The SMTP server will send a positive intermediate
	 * response on the successful completion of one part of a multi-part sequence of commands. For
	 * example, after a successful DATA command, a positive intermediate response will be sent to
	 ...
	 * negative transient responses. The SMTP server will send a negative transient response on the
	 ...
	 * negative permanent responses. The SMTP server will send a negative permanent response on the
