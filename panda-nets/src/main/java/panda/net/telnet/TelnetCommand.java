...
/**
 * The TelnetCommand class cannot be instantiated and only serves as a storehouse for telnet command
 * constants.
 * 
 * @see panda.net.telnet.Telnet
 * @see panda.net.telnet.TelnetClient
 */
...
public final class TelnetCommand {
	...
	/***
	 * Returns the string representation of the telnet protocol command corresponding to the given
	 * command code.
	 * <p>
	 * 
