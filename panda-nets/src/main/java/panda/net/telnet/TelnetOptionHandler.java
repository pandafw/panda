...
/***
 * The TelnetOptionHandler class is the base class to be used for implementing handlers for telnet
 * options.
 * <p>
 * TelnetOptionHandler implements basic option handling functionality and defines abstract methods
 * that must be implemented to define subnegotiation behaviour.
 ***/
public abstract class TelnetOptionHandler {
	...
	/***
	 * Constructor for the TelnetOptionHandler. Allows defining desired initial setting for
	 ...
	 * <p>
	 * This implementation returns null, and must be overridden by the actual TelnetOptionHandler to
	 * specify which response must be sent for the subnegotiation request.
	 * <p>
	 * 
	 ...
	 *            <p>
	 * @return response to be sent to the subnegotiation sequence. TelnetClient will add IAC SB
	 *         &amp; IAC SE. null means no response
	 ***/
	...
	/***
	 * This method is invoked whenever this option is acknowledged active on the local end
	 * (TelnetClient sent a WILL, remote side sent a DO). The method is used to specify a
	 * subnegotiation sequence that will be sent by TelnetClient when the option is activated.
	 * <p>
	 * This implementation returns null, and must be overriden by the actual TelnetOptionHandler to
	 * specify which response must be sent for the subnegotiation request.
	 * 
	 * @return subnegotiation sequence to be sent by TelnetClient. TelnetClient will add IAC SB
	 *         &amp; IAC SE. null means no subnegotiation.
	 ***/
	...
	/***
	 * This method is invoked whenever this option is acknowledged active on the remote end
	 * (TelnetClient sent a DO, remote side sent a WILL). The method is used to specify a
	 * subnegotiation sequence that will be sent by TelnetClient when the option is activated.
	 * <p>
	 * This implementation returns null, and must be overriden by the actual TelnetOptionHandler to
	 * specify which response must be sent for the subnegotiation request.
	...
	/***
	 * Returns a boolean indicating whether a WILL request sent to the other side has been
	 * acknowledged.
	 * <p>
	 * 
	...
	/***
	 * Tells this option whether a WILL request sent to the other side has been acknowledged
	 * (invoked by TelnetClient).
	 * <p>
	 * 
	...
	/***
	 * Returns a boolean indicating whether a DO request sent to the other side has been
	 * acknowledged.
	 * <p>
	 * 
	...
	/***
	 * Tells this option whether a DO request sent to the other side has been acknowledged (invoked
	 * by TelnetClient).
	 * <p>
	 * 
