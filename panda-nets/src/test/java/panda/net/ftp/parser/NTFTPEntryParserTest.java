...
public class NTFTPEntryParserTest extends CompositeFTPParseTestFramework {
	...
	private static final String[][] goodsamples = { { // DOS-style tests
					...
					"01-01-98  05:00       <DIR>          Network", "01-01-98  05:00       <DIR>          StorageCard",
					...
					"09-13-10  13:08       <DIR>          Program Files", "09-13-10  13:08       <DIR>          Temp",
					"09-13-10  13:08       <DIR>          Windows", }, { // Unix-style tests
	...
	private static final String[][] badsamples = { { // DOS-style tests
			"20-05-97  03:31PM                  681 .bash_history", "     0           DIR   05-19-97   12:56  local",
					"     0           DIR   05-12-97   16:52  Maintenance Desktop", }, { // Unix-style
																							// tests
	...
	/**
	 * @see panda.net.ftp.parser.FTPParseTestFramework#getParser()
	 */
	@Override
	...
	/**
	 * @see panda.net.ftp.parser.FTPParseTestFramework#testParseFieldsOnDirectory()
	 */
	@Override
	...
	/*
	 * test condition reported as bug 20259 - now NET-106. directory with name beginning with a
	 * numeric character was not parsing correctly
	 */
	...
	private static final byte[] listFilesByteTrace = { 48, 57, 45, 48, 52, 45, 49, 51, 32, 32, 48, 53, 58, 53, 49, 80,
			77, 32, 32, 32, 32, 32, 32, 32, 60, 68, 73,
			82,
			62,
			32,
			32,
			...
			13,
			10, // 1
			48, 55, 45, 49, 55, 45, 49, 51, 32, 32, 48, 50, 58, 53, 52, 80, 77, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32,
			32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 50, 32, 65, 95, 113, 117, 105, 99, 107, 95, 98, 114, 111, 119, 110,
			95, 102, 111, 120, 95, 106,
			117,
			109,
			112,
			115,
			...
			13,
			10, // 2
			48, 55, 45, 49, 55, 45, 49, 51, 32, 32, 48, 50, 58, 49, 55, 80, 77, 32, 32, 32, 32, 32,
			32,
			32,
			32,
			32,
			...
			13,
			10, // 3
			48, 55, 45, 49, 55, 45, 49, 51, 32, 32, 48, 49, 58, 52, 57, 80, 77, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32,
			32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 52, 32, -126, -28, -126, -83, -119, -51, -126, -52, -105, -84,
			-126, -22, -126, -51, -112, -30, -126, -90, -126, -72, -126, -75, -126, -60, -127, 65, -126, -75, -126,
			-87, -126, -32, -126, -32, -126,
			-58,
			-126,
			-52,
			-112,
			...
			13,
			10, // 4
			48, 55, 45, 49, 55, 45, 49, 51, 32, 32, 48, 50, 58, 52, 54, 80, 77, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32,
			32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 53, 32, -125, 76, -125, -125, -125,
			98,
			-125,
			86,
			-125,
			...
			10, // 5
			48, 55, 45, 49, 55, 45, 49, 51, 32, 32, 48, 50, 58, 52, 54, 80, 77, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32,
			32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 54, 32, -125, 76, -125, -125, -125, 98, -125, 86, -125,
			-123,
			-125,
			116,
			-125,
			...
			10, // 6
			48, 55, 45, 49, 55, 45, 49, 51, 32, 32, 48, 49, 58, 52, 57, 80, 77, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32,
			32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 55, 32, -114,
			79,
			-116,
			-38,
			-126,
			...
			10, // 7
			48, 55, 45, 49, 55, 45, 49, 51, 32, 32, 48, 49, 58, 52, 57, 80, 77, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32,
			32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 56, 32, -111,
			-66,
			-116,
			-10,
			-106,
			...
			10, // 8
			48, 55, 45, 49, 55, 45, 49, 51, 32, 32, 48, 50, 58, 53, 52, 80, 77, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32,
			32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 57, 32,
			-113,
			-84,
			-106,
			-20,
			...
			10, // 9
			48, 55, 45, 49, 55, 45, 49, 51, 32, 32, 48, 49, 58, 52, 57, 80, 77, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32,
			32, 32, 32, 32, 32, 32, 32, 32, 32, 49, 48, 32, -119, -28, -109, 99, -118, -108, -114, -82, -119, -17,
			-114, -48, -120, -8, -112, -123, -108, 95,
			-117,
			-58,
			46,
			80,
			...
			13,
			10, // 10
			48, 55, 45, 49, 55, 45, 49, 51, 32, 32, 48, 50, 58, 49, 49, 80, 77, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32,
			32, 32, 32, 32, 32, 32, 32, 32, 32, 49, 49, 32, -112, -124, -99,
			-56,
			46,
			116,
			120,
			...
			13,
			10, // 11
			48, 55, 45, 49, 55, 45, 49, 51, 32, 32, 48, 50, 58, 52, 51, 80, 77, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32,
			32, 32, 32, 32, 32, 32, 32, 32, 32, 49, 50, 32,
			-117,
			-76,
			-116,
			-123,
			13,
			10, // 12
			48, 55, 45, 49, 55, 45, 49, 51, 32, 32, 48, 50, 58, 49, 50, 80, 77, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32,
			32, 32, 32, 32, 32, 32, 32, 32, 32, 49, 51, 32, -114, -107, -111, -123, -108,
			94,
			-104,
			82,
			13,
			10, // 13
			48, 55, 45, 48, 51, 45, 49, 51, 32, 32, 48, 50, 58, 51, 53, 80, 77, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32,
			32, 32, 32, 32, 32, 32, 32, 32, 32, 49, 52, 32, -112, -123, -117, -101, -126, -52, -116, -16, -126, -19,
			-126, -24, 46, 116, 120,
			116,
			13,
			10, // 14
			48, 55, 45, 49, 55, 45, 49, 51, 32, 32, 48, 50, 58, 49, 50, 80, 77, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32,
			32, 32, 32, 32, 32, 32, 32, 32, 32, 49, 53, 32, -114, -123, -117, -101, -112, -20,
			13,
			10, // 15
			48, 55, 45, 49, 55, 45, 49, 51, 32, 32, 48, 49, 58, 52, 57, 80, 77, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32,
			32, 32, 32, 32, 32, 32, 32, 32, 32, 49, 54, 32, -107, -94, -112, -123, -106, 126, -126, -55, -107, -44,
			-126, -25, -126, -72, 46, 116, 120, 116, 13, 10 // 16
	};
	...
	public void testNET516() throws Exception { // problem where part of a multi-byte char gets
												// converted to 0x85 = line term
