 ...
 * normal FTPClient cannot handle the different date formats in these entries, however using a
 * configurable format, we can handle it easily. The original system presenting this issue was an
 * AIX system - see bug #27437 for details.
 * 
...
public class FTPConfigEntryParserTest extends TestCase {
	...
	/**
	 * This is a new format reported on the mailing lists. Parsing this kind of entry necessitated
	 * changing the regex in the parser.
	 */
