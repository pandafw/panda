...
public class MLSxEntryParserTest extends FTPParseTestFramework {
	...
	private static final String[] badsamples = {
			"Type=cdir;Modify=20141022065101;UNIX.mode=0775;/no/space", // no space between facts
																		// and name
			"Type=cdir;Modify=20141022065103;UNIX.mode=0775;", // no name or space
			"/no/leading/space",
			"", // empty
			"Type=cdir;Modify=20141022065102;UNIX.mode=0775; ", // no name
			"Type=dir;Size; missing =size", "Type=dir missing-semicolon", "Type= missing value and semicolon",
			" ", // no path
	...
	private static final String[] goodsamples = { "Type=cdir;Modify=20141022065102;UNIX.mode=0775; /commons/net",
			...
			" /no/facts", // no facts
			"Type=; /empty/fact", "Size=; /empty/size",
			" Type=cdir;Modify=20141022065102;UNIX.mode=0775; /leading/space", // leading space
																				// before facts =>
																				// it's a file name!
			"  ", // pathname of space
	};
	...
	/**
	 * Check if FTPFile entry parsing failed; i.e. if entry is null. We override parent check, as a
	 * null timestamp is not acceptable for these tests.
	 * 
