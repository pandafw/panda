...
public class UnixFTPEntryParserTest extends FTPParseTestFramework {
	...
	public void testNumericDateFormat() {
		String testNumericDF = "-rw-r-----   1 neeme neeme   346 2005-04-08 11:22 services.vsp";
		String testNumericDF2 = "lrwxrwxrwx   1 neeme neeme    23 2005-03-02 18:06 macros -> ./../../global/macros/.";

		UnixFTPEntryParser parser = new UnixFTPEntryParser(UnixFTPEntryParser.NUMERIC_DATE_CONFIG);
	...
	public void testOwnerAndGroupNameWithSpaces() {
		FTPFile f = getParser().parseFTPEntry(
			"drwxr-xr-x   2 john smith     test group         4096 Mar  2 15:13 zxbox");
		assertNotNull(f);
		assertEquals("john smith", f.getUser());
	...
	public void testLeadingSpacesNET566() { // check new behaviour
		FTPFile f = new UnixFTPEntryParser(null, false)
			.parseFTPEntry("drwxr-xr-x   2 john smith     group         4096 Mar  2 15:13   zxbox");
		assertNotNull(f);
		assertEquals("  zxbox", f.getName()); // leading spaces retained
	}

	public void testTrimLeadingSpacesNET566() { // check can trim spaces as before
		FTPFile f = new UnixFTPEntryParser(null, true)
			.parseFTPEntry("drwxr-xr-x   2 john smith     group         4096 Mar  2 15:13   zxbox");
		assertNotNull(f);
