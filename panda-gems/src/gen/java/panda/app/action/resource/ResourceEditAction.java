...
public class ResourceEditAction extends GenericEditAction<Resource> {
	...
	public ResourceEditAction() {
		...
		setDisplayFields(Resource.ID, Resource.CLAZZ, Resource.LOCALE, Resource.SOURCE, Resource.STATUS, Resource.UPDATED_AT, Resource.UPDATED_BY, Resource.UPDATED_BY_NAME, Resource.UPDATED_BY_USER);
	}
	...
	@At
	@To(Views.SJSON)
	public Object view_json(@Param Resource key) {
		return super.view(key);
	}
	...
	@At
	@To(Views.SXML)
	public Object view_xml(@Param Resource key) {
		return super.view(key);
	}
